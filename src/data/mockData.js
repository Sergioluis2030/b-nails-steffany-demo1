...
export const testimonios = [
  {id:1,nombre:"Mariana López",servicio:"Semipermanente",texto:"Mis uñas quedaron perfectas y duraron más de 3 semanas. El trato de Steffany es increíble, me sentí consentida todo el tiempo.",estrellas:5},
  {id:2,nombre:"Fernanda Ruiz",servicio:"Acrílico",texto:"La higiene es de otro nivel, todo desinfectado y con materiales de primera. El diseño que me hizo fue exactamente lo que soñaba.",estrellas:5},
  {id:3,nombre:"Paola Méndez",servicio:"Nail Art",texto:"Un lugar elegante y acogedor. Reservé por la página en minutos y quedé encantada con el resultado. ¡Ya tengo mi próxima cita!",estrellas:5},
...
export const cardsDestacadas = [
  ...
  {icon:"💅",titulo:"Arte profesional",texto:"Técnica certificada con años de experiencia en uñas de salón."},
  {icon:"🌿",titulo:"Productos premium",texto:"Marcas de alta calidad, libres de tóxicos y amables con tus uñas."},
  {icon:"💆‍♀️",titulo:"Experiencia relajante",texto:"Ambiente elegante y acogedor pensado para que te consintas."},
];